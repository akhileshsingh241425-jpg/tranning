        ...
        <div className="chatbot-window">
          ...
          <div className="chatbot-header">
            ...
            <div className="chatbot-header-actions">
              <a href="tel:+919876543210" className="chatbot-action-btn" title="Call us">
                <FaPhone />
              </a>
              <a href="https://wa.me/919876543210" className="chatbot-action-btn whatsapp" title="WhatsApp" target="_blank" rel="noopener noreferrer">
                <FaWhatsapp />
              </a>
